...
public class SpielfeldView extends View implements OnTouchListener {
	...
	protected void onDraw(Canvas canvas) {
		 ...
		 * Ansonsten würde das zu einer NullPointer-Exception führen. Dies
		 * wird auch benötigt, um korrekt im GUI-Editor dargestellt zu werden.
		 */
		if (spielfeld == null) {
	...
	public boolean onTouch(View view, MotionEvent event) {
		 ...
		 * getätigt. Wir schreiben seine Eingabe in eine Zwischenvariable die
