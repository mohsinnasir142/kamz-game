...
public class Kaestchen {
	...
	public int getPixelX() {
		return rasterX * SpielfeldView.KAESTCHEN_SEITENLAENGE
				+ SpielfeldView.PADDING;
	}

	public int getPixelY() {
		return rasterY * SpielfeldView.KAESTCHEN_SEITENLAENGE
				+ SpielfeldView.PADDING;
	}
	...
	public Rect getRectStrichOben() {
		...
		return new Rect(getPixelX() + SpielfeldView.KAESTCHEN_SEITENLAENGE / 4,
				getPixelY() - SpielfeldView.KAESTCHEN_SEITENLAENGE / 4,
				getPixelX()
						+ (int) (SpielfeldView.KAESTCHEN_SEITENLAENGE * 0.75),
				getPixelY() + SpielfeldView.KAESTCHEN_SEITENLAENGE / 4);
	}
	...
	public Rect getRectStrichUnten() {
		...
		return new Rect(getPixelX() + SpielfeldView.KAESTCHEN_SEITENLAENGE / 4,
				...
				getPixelX()
						+ (int) (SpielfeldView.KAESTCHEN_SEITENLAENGE * 0.75),
				getPixelY() + SpielfeldView.KAESTCHEN_SEITENLAENGE
						+ SpielfeldView.KAESTCHEN_SEITENLAENGE / 4);
	}
	...
	public Rect getRectStrichLinks() {
		...
		return new Rect(getPixelX() - SpielfeldView.KAESTCHEN_SEITENLAENGE / 4,
				getPixelY() + SpielfeldView.KAESTCHEN_SEITENLAENGE / 4,
				getPixelX() + SpielfeldView.KAESTCHEN_SEITENLAENGE / 4,
				getPixelY()
						+ (int) (SpielfeldView.KAESTCHEN_SEITENLAENGE * 0.75));
	}
	...
	public Rect getRectStrichRechts() {
		...
		return new Rect(getPixelX()
				+ (int) (SpielfeldView.KAESTCHEN_SEITENLAENGE * 0.75),
				getPixelY() + SpielfeldView.KAESTCHEN_SEITENLAENGE / 4,
				getPixelX() + SpielfeldView.KAESTCHEN_SEITENLAENGE
						+ SpielfeldView.KAESTCHEN_SEITENLAENGE / 4, getPixelY()
						+ (int) (SpielfeldView.KAESTCHEN_SEITENLAENGE * 0.75));
	}
	...
	public Strich ermittleStrich(int pixelX, int pixelY) {
		...
		if (getRectStrichOben() != null
				&& getRectStrichOben().contains(pixelX, pixelY))
			return strichOben;

		if (getRectStrichUnten() != null
				&& getRectStrichUnten().contains(pixelX, pixelY))
			return strichUnten;

		if (getRectStrichLinks() != null
				&& getRectStrichLinks().contains(pixelX, pixelY))
			return strichLinks;

		if (getRectStrichRechts() != null
				&& getRectStrichRechts().contains(pixelX, pixelY))
			return strichRechts;
	...
	public void onDraw(Canvas canvas) {
		...
		if (besitzer != null) {
			...
			Rect destRect = new Rect(getPixelX(), getPixelY(), getPixelX()
					+ SpielfeldView.KAESTCHEN_SEITENLAENGE, getPixelY()
					+ SpielfeldView.KAESTCHEN_SEITENLAENGE);
		...
		canvas.drawLine(getPixelX(), getPixelY()
				+ SpielfeldView.KAESTCHEN_SEITENLAENGE, getPixelX()
				+ SpielfeldView.KAESTCHEN_SEITENLAENGE, getPixelY()
				+ SpielfeldView.KAESTCHEN_SEITENLAENGE, rahmenPaint);
		...
		canvas.drawLine(getPixelX() + SpielfeldView.KAESTCHEN_SEITENLAENGE,
				getPixelY(),
				getPixelX() + SpielfeldView.KAESTCHEN_SEITENLAENGE, getPixelY()
						+ SpielfeldView.KAESTCHEN_SEITENLAENGE, rahmenPaint);

		/* Eckpunkte zeichnen */
		rahmenPaint.setColor(Color.BLACK);
		canvas.drawRect(getPixelX() - 1, getPixelY() - 1, getPixelX() + 1,
				getPixelY() + 1, rahmenPaint);
		canvas.drawRect(getPixelX() + SpielfeldView.KAESTCHEN_SEITENLAENGE - 1,
				getPixelY() - 1, getPixelX()
						+ SpielfeldView.KAESTCHEN_SEITENLAENGE + 1,
				getPixelY() + 1, rahmenPaint);
		canvas.drawRect(getPixelX() - 1, getPixelY()
				+ SpielfeldView.KAESTCHEN_SEITENLAENGE - 1, getPixelX() + 1,
				getPixelY() + SpielfeldView.KAESTCHEN_SEITENLAENGE + 1,
				rahmenPaint);
		canvas.drawRect(getPixelX() + SpielfeldView.KAESTCHEN_SEITENLAENGE - 1,
				getPixelY() + SpielfeldView.KAESTCHEN_SEITENLAENGE - 1,
				getPixelX() + SpielfeldView.KAESTCHEN_SEITENLAENGE + 1,
				getPixelY() + SpielfeldView.KAESTCHEN_SEITENLAENGE + 1,
				rahmenPaint);
	}
	...
	public String toString() {
		return "Kaestchen [rasterX=" + rasterX + ", rasterY=" + rasterY
				+ ", besitzer=" + besitzer + "]";
	}
